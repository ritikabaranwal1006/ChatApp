...
public class Server implements ActionListener {
    ...
    static JPanel a1;
        ...
        p1.add(morevert);
                ...
                typingIndicator.setBounds(5, 630, 310, 20);
                typingIndicator.setFont(new Font("SAN_SERIF", Font.PLAIN, 14));
                typingIndicator.setForeground(Color.GRAY);
                f.add(typingIndicator);
